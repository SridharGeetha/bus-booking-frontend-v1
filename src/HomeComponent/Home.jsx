        ...
        <div className="pt-20 relative min-h-screen overflow-x-hidden bg-linear-to-t from-blue-700 to-slate-950 text-white">
          ...
          <section className="relative z-10 max-w-6xl mx-auto px-4 py-8">
            ...
            <div className="backdrop-blur-md bg-transparent border border-cyan-400/30 rounded-3xl p-8 shadow-2xl">
              ...
              <div className="flex flex-col md:flex-row gap-4 items-center bg-transparent border border-cyan-400 rounded-full p-3 mb-6 focus-within:ring-4 focus-within:ring-cyan-400/30 transition-all">
                <input
                  type="text"
                  placeholder="Enter Bus ID (e.g., 101)"
                  onChange={(e) => setBusId(e.target.value)}
                  className="flex-1 bg-transparent text-cyan-300 placeholder:text-gray-400 text-lg px-4 outline-none"
                />
                <button
                  onClick={handleSearchBus}
                  className="w-40 bg-blue-500 shadow-md shadow-blue-500/50 hover:bg-blue-600 text-white font-medium py-3 rounded-3xl transition duration-200"
                >
                  Search Bus
                </button>
              </div>
              ...
              {loading ? (
                ...
                <>
                  {busData && (
                    <div className="bg-white/10 border border-cyan-500/30 rounded-2xl p-6 mb-8">
          ...
          <section className="relative z-10 py-16">
            <div className="h-96 rounded-md flex flex-col antialiased items-center justify-center relative overflow-hidden">
              {allBuses.length > 0 ? (
                ...
                <p className="text-gray-400 text-lg">No buses available right now.</p>
              )}
            </div>
          </section>
        </div>
